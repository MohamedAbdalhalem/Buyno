...
export default function Cart() {
  const {numOfCartItems, totalCartPrice, products,handleDeleteProduct,handleClearCart,handleUpdateProductQuantity,productId,isClearLouding,isDeleteLouding,setProductId} =  useCart()
  return (
