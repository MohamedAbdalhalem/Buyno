...
import useDarkModd from "./useDarkModd";
...
export function Nav() {
  ...
  const {isDrak,handleDarkLightMode} = useDarkModd()

  return (
    <Navbar className="rounded-none py-5 shadow-md dark:bg-gray-900 fixed z-50 w-full" fluid>
      <Link to="/">
        <NavbarBrand>
