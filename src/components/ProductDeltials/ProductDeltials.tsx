...
import useProductDetials from './useProductDetials';
...
export default function ProductDeltials() {
  ...
  const {productDetials,isLoading,products,handleAddToProduct,handleAddToWishlist,handleRemoveFromWishlist} = useProductDetials()
    if (isLoading) {
        return (
    ...
    return (
    <div className='px-4 pb-4 pt-20 product-detials'>
